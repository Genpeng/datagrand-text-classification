...
def main():
    ...
    print("[INFO] The total number of words is: %d" % len(set(words)))
    ...
    model.wv.save("../../embeddings/datagrand-word-300d-mc5.bin")
    model.wv.save_word2vec_format("../../embeddings/datagrand-word-300d-mc5.txt", binary=False)
    print("[INFO] Finished!")
